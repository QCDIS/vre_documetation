...
For example to see the results of the 'process-the-list' cell click on of the cells
![Workflow Engine](images/workflow_engine_5.png)

On the right panel you will see the cells information such as start and end time. At the bottom of th panel you can see
